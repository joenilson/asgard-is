 ...
 */
Ext.define('Asgard.lib.grid.trainingplan',{
    extend: 'Asgard.lib.GridPanel',
    alias: 'widget.gridtrainingplan',
    autoShow: true,
    autoDestroy: true,
    autoScroll: true,
    border: true,
    ...
    titleNewAuditPlan: 'Add new Training Plan',
    titleEditAuditPlan: 'Edit Training Plan',
    loadingFileText: 'Loading Training Plan... please wait...',
    ...
    fnLibraryTool: function(event, e, object, tool) {
        ...
        if(companies.length !== 4){
            ...
            if(tool.type==='plus'){
                ...
                winContent = new Ext.create('Asgard.lib.forms.trainingNewTrainingPlan',{
                ...
                var editAuditPlan = Ext.create('Asgard.lib.forms.trainingNewTrainingPlan', { companiesValue: AuditCompany, countriesValue: AuditCountry, locationsValue: AuditLocation, innerPanel: panel, baseParams: { trainingplan_id: AuditId }});
                editAuditPlan.getForm().load({
                    url: 'ims/formtrainingplan',

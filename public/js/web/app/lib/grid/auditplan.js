 ...
 */
Ext.define('Asgard.lib.grid.auditplan',{
    extend: 'Asgard.lib.GridPanel',
    alias: 'widget.gridauditplan',
    autoShow: true,
    autoDestroy: true,
    autoScroll: true,
    border: true,
    ...
    flex: 1,
    layout: 'fit',
    titleText: 'Audit Plan List',
    idText: 'Id',
    nameText: 'Description',
    datebeginText: 'Date Begin',
    ...
    initComponent: function(){
        ...
        this.columns =  {
            ...
            items: [
                ...
                {text: this.datebeginText, flex: 1, sortable: false, hidden: false, dataIndex: 'audit_begin', renderer : Ext.util.Format.dateRenderer('Y-m-d'), filter: true},
                {text: this.dateendText, flex: 1, sortable: false, hidden: false, dataIndex: 'audit_end', renderer : Ext.util.Format.dateRenderer('Y-m-d'), filter: true},

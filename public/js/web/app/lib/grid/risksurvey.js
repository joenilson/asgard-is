 ...
 */
Ext.define('Asgard.lib.grid.risksurvey',{
    extend: 'Asgard.lib.GridPanel',
    alias: 'widget.gridrisksurvey',
    autoShow: true,
    autoDestroy: true,
    autoScroll: true,
    border: true,
    ...
    titleNewAuditor: 'Add new Risk Survey',
    titleEditAuditor: 'Edit Risk Survey data',

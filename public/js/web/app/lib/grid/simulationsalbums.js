 ...
 */
Ext.define('Asgard.lib.grid.simulationsalbums',{
    extend: 'Asgard.lib.GridPanel',
    alias: 'widget.gridsimulationsalbums',
    autoShow: true,
    autoDestroy: true,
    autoScroll: true,
    border: true,
    ...
    dateText: 'Date',    
    toolAddText: 'Add Simulation',
    toolRemoveText: 'Remove Simulation',
    toolChangeText: 'Change Simulation',
    uploadToolText: 'Mass Upload',
    titleNewAuditor: 'Add new Simulation',
    titleEditAuditor: 'Edit Simulation data',
    ...
    initComponent: function(){
        ...
        */
        ...
        this.columns =  {
            ...
            items: [
                {text: this.idText, flex: 1, sortable: false, hidden: true, dataIndex: 'id', filter: false},
                {text: this.nameText, flex: 2, sortable: false, hidden: false, dataIndex: 'description', filter: true, tdCls: 'wrapText'},
                {text: this.dateText, flex: 1, sortable: false, hidden: false, dataIndex: 'date_simulation', filter: true, renderer : Ext.util.Format.dateRenderer('Y-m-d'),tdCls: 'wrapText'}
            ]
        };

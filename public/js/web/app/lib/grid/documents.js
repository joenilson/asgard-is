   ...
   autoShow: true,
    ...
    initComponent: function(){
        ...
        this.columns =  {
            ...
            items: [
                {text: this.idText, sortable: false, width: 60, hidden: false, dataIndex: 'doc_id', filter: true},
                {text: this.classDocText, width: 180, sortable: true, filter: 'combo', dataIndex: 'desc_classification', tdCls: 'wrapText', hidden: (this.typeDoc==='DOC' && this.sourceDoc !== 'external')?false:true},
                ...
                {text: this.recordText, width: 140, sortable: true, filter: true, dataIndex: 'doc_record', tdCls: 'wrapText'},
                ...
                {text: this.typeText, width: 120, sortable: true, filter: 'combo', dataIndex: 'desc_type', tdCls: 'wrapText', hidden: (this.typeDoc==='DOC' && this.sourceDoc !== 'external')?false:true},
                {text: this.versionText, width: 60, sortable: true, filter: true, dataIndex: 'doc_version_number', tdCls: 'wrapText', hidden: (this.typeDoc==='DOC' && this.sourceDoc !== 'external')?false:true},
                {text: this.dateRevisionText, width: 100,  sortable: true, filter: true, dataIndex: 'doc_date_revision_next', tdCls: 'wrapText',  xtype: 'datecolumn', format:'Y-m-d', hidden: (this.typeDoc==='DOC' && this.sourceDoc !== 'external')?false:true },
                ...
                {text: this.minimalTimeText, width: 100,  sortable: true, filter: 'combo', dataIndex: 'desc_regretention', tdCls: 'wrapText', hidden: (this.typeDoc==='REG')?false:true },
                {xtype: 'actioncolumn', width: 70, sortable: false, menuDisabled: true, hidden: (this.typeDoc==='DOC' && this.sourceDoc !=='external')?false:true, 
                    items: [
                        {

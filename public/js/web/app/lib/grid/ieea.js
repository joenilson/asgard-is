    ...
    initComponent: function(){
        ...
        this.columns =  {
            ...
            items: [
                ...
                {text: this.IdTypeText, width: 100, sortable: false, hidden: false, dataIndex: 'desc_type', filter: true, tdCls: 'wrapText'},
                {text: this.IdCycleText, width: 100, sortable: false, hidden: false, dataIndex: 'desc_cycle', filter: true, tdCls: 'wrapText'},
                {text: this.IdProcessText, width: 100, sortable: false, hidden: false, dataIndex: 'desc_process', filter: true, tdCls: 'wrapText'},
                {text: this.IdThreadText, width: 100, sortable: false, hidden: false, dataIndex: 'desc_thread', filter: true, tdCls: 'wrapText'},
                {text: this.IdEaText, width: 100, sortable: false, hidden: false, dataIndex: 'desc_ea', filter: true, tdCls: 'wrapText'},
                {text: this.IdEiText, width: 100, sortable: false, hidden: false, dataIndex: 'desc_ei', filter: true, tdCls: 'wrapText'},
                {text: this.QuantityText, width: 50, sortable: false, hidden: false, dataIndex: 'quantity', filter: true, tdCls: 'wrapText'},
                {text: this.UnitMeasureText, width: 50, sortable: false, hidden: false, dataIndex: 'unit_measure', filter: true, tdCls: 'wrapText'},

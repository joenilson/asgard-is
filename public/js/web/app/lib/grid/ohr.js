 ...
 */
Ext.define('Asgard.lib.grid.ohr',{
    extend: 'Asgard.lib.GridPanel',
    alias: 'widget.gridohr',
    autoShow: true,
    autoDestroy: true,
    autoScroll: true,
    border: true,
    ...
    layout: 'fit',
    idText: 'Id',
    titleText: 'Occupational Health Registry',
    typeText: 'Type',
        ...
        */
        ...
        this.columns =  {
            ...
            items: [
                ...
                {text: this.typeText, flex: 1, sortable: true, hidden: false, dataIndex: 'desc_type', filter: true, renderer: this.renderType},

 ...
 */
Ext.define('Asgard.lib.grid.IPGrid',{
    extend: 'Asgard.lib.GridPanel',
    alias: 'widget.ip_detailsgrid',
    autoShow: true,
    autoDestroy: true,
    autoScroll: true,
    border: true,
    ...
    */
    ...
    initComponent: function(){
        ...
        */
        ...
        this.features = [{
            ftype: 'grouping',
            groupHeaderTpl: this.typeText+': {name}',
        ...
        this.columns =  {
            ...
            items: [
                ...
                {text: this.threadText, flex: 1, sortable: true, hidden: false, dataIndex: 'desc_thread', filter: true, tdCls: 'wrapText' },
                {text: this.ioText, width: 30, sortable: true, hidden: this.ioStatus, dataIndex: 'id_io', filter: (this.ioStatus===true)?false:true, tdCls: 'wrapText' },
                {text: this.nameText, flex: 2, sortable: true, hidden: false, dataIndex: 'description', filter: true, tdCls: 'wrapText' }
            ]
        };

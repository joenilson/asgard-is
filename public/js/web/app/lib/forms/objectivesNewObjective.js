 ...
 */
Ext.define('Asgard.lib.forms.objectivesNewObjective',{
    extend: 'Ext.form.Panel',
    alias: 'widget.newobjective',
    url: 'ims/addobjectives',

    descriptionText: 'Description',
    fileText: 'Objective in PDF',
    fileFieldEmptyText: 'Choose a pdf file',    
    textSubmitButton: 'Send',
    textCancelButton: 'Cancel',

    warningTitle: 'Warning',
    warningText: 'Objective exists!, please remove the old one first',
    required: '<span style="color:red;font-weight:bold" data-qtip="Required">*</span>',
    successText: 'Objective added succefully!',

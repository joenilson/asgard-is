 ...
 */
Ext.define('Asgard.lib.forms.organigramNewOrganigram',{
    extend: 'Ext.form.Panel',
    alias: 'widget.neworganigram',
    url: 'ims/addorganigram',

    descriptionText: 'Description',
    fileText: 'Organigram in PDF',
    fileFieldEmptyText: 'Choose a pdf file',    
    textSubmitButton: 'Send',
    textCancelButton: 'Cancel',

    warningTitle: 'Warning',
    warningText: 'Organigram exists!, please remove the old one first',
    required: '<span style="color:red;font-weight:bold" data-qtip="Required">*</span>',
    successText: 'Organigram added succefully!',

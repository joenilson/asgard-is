 ...
 */
Ext.define('Asgard.lib.forms.reqsMasterFileUpload',{
    extend: 'Ext.form.Panel',
    alias: 'widget.reqsmasterfileupload',
    url: 'ims/massreqprocess',
        ...
        if(form.isValid()){
            form.submit({
                ...
                success: function(fp, o, m, r) {
                    ...
                    var gridStore = Ext.create('Asgard.store.ReqsUpload',{
                       data: result.file_results
                    });
                    var gridContent = Ext.create('Asgard.lib.grid.requirements_upload',{
                        store: gridStore
                    });

 ...
 */
Ext.define('Asgard.lib.forms.hiraMasterFileUpload',{
    extend: 'Ext.form.Panel',
    alias: 'widget.hiramasterfileupload',
    url: 'ims/masshiraprocess',
        ...
        if(form.isValid()){
            form.submit({
                ...
                success: function(fp, o, m, r) {
                    ...
                    var gridContent = Ext.create('Asgard.lib.grid.hira_upload',{
                        store: gridStore
                    });

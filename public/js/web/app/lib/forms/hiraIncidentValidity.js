 ...
 */
Ext.define('Asgard.lib.forms.hiraIncidentValidity',{
    extend: 'Ext.form.Panel',
    alias: 'widget.newincidentvalidity',
    url: 'ims/addincidentvalidity',

    objectIncidentText: 'Incident',
    objectValidityDescriptionText: 'Validity Description',
    baseParams: { module: 'incidentvalidity' },
    objectIncidentValue: '',
    textSubmitButton: 'Send',
    textCancelButton: 'Cancel',

    successText: 'Validity saved succefully!',
    failureText: 'Something is wrong, please try it again',
    
    objectIncidentField: undefined,
    objectValidityDescriptionField: undefined,
    ...
    initComponent: function(){
        ...
        this.objectValidityDescriptionField = this.objectValidityDescriptionField || [];
        this.objectValidityDescriptionField = Ext.Object.merge({
            fieldLabel: this.objectValidityDescriptionText,
            xtype: 'textareafield',
            name: 'validity_description',
            anchor: '100%',
            height: 150,
            allowBlank:false
        }, this.objectValidityDescriptionField);

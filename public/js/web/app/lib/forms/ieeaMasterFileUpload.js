 ...
 */
Ext.define('Asgard.lib.forms.ieeaMasterFileUpload',{
    extend: 'Ext.form.Panel',
    alias: 'widget.ieeamasterfileupload',
    url: 'ims/massieeaprocess',
        ...
        if(form.isValid()){
            form.submit({
                ...
                success: function(fp, o, m, r) {
                    ...
                    var gridStore = Ext.create('Asgard.store.IEEAUpload',{
                       data: result.file_results
                    });
                    var gridContent = Ext.create('Asgard.lib.grid.ieea_upload',{
                        store: gridStore
                    });

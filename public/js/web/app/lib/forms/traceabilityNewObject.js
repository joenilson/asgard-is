 ...
 */
Ext.define('Asgard.lib.forms.traceabilityNewObject',{
    extend: 'Ext.form.Panel',
    alias: 'widget.newtraceability',
    url: 'ims/addtraceability',

    descriptionText: 'Description',
    fileText: 'Traceability in PDF',
    fileFieldEmptyText: 'Choose a PDF file',    
    textSubmitButton: 'Send',
    textCancelButton: 'Cancel',

    warningTitle: 'Warning',
    warningText: 'Traceability exists!, please remove the old one first',
    required: '<span style="color:red;font-weight:bold" data-qtip="Required">*</span>',
    successText: 'Traceability added succefully!',

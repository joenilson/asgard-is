 ...
 */
Ext.define('Asgard.lib.forms.comboCCLPY', { 
    ...
    initComponent: function(){
        ...
        this.submitButton = Ext.Object.merge({
                ...
                type: 'button',
                scope: me,
                handler: fnCCLPYProcess
            }, this.submitButton);
        
        this.items = this.items || [];
        this.items = this.items.concat([ this.companiesField, this.countriesField, this.locationsField, this.processField, this.dateField ]);

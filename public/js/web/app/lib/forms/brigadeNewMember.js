 ...
 */
Ext.define('Asgard.lib.forms.brigadeNewMember',{
    extend: 'Ext.form.Panel',
    alias: 'widget.brigadenewmember',
    url: 'ims/addsimulationsbrigade',
    ...
    initComponent: function(){
        var me = this;
        var committee = new Ext.create('Asgard.store.SimulationsBrigade');
        ...
        this.positionField = Ext.Object.merge({
            xtype: 'brigadepositionscombo',
            anchor: '100%',
            store: new Ext.create('Asgard.store.BrigadePositions')
        }, this.positionField);

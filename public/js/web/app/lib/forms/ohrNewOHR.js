 ...
 */
Ext.define('Asgard.lib.forms.ohrNewOHR',{
    ...
    warningText: 'Occupational Health Registry exists!, revise your data',
    required: '<span style="color:red;font-weight:bold" data-qtip="Required">*</span>',
    successText: 'Occupational Health Registry loaded succefully!',
    ...
    initComponent: function(){
        ...
        this.typeField = Ext.Object.merge({
            xtype: 'ohrtypecombo',
            anchor: '100%',
            store: new Ext.create('Asgard.store.OHRType')
        }, this.typeField);

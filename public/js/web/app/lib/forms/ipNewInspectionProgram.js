 ...
 */
Ext.define('Asgard.lib.forms.ipNewInspectionProgram',{
    extend: 'Ext.form.Panel',
    alias: 'widget.newinspectionprogram',
    url: 'ims/addinspectionprogram',
    ...
    warningText: 'Inspection Program exists!, revise your data',
    required: '<span style="color:red;font-weight:bold" data-qtip="Required">*</span>',
    successText: 'Inspection Program loaded succefully!',
    ...
    fnSubmit: function(button, event) {
        ...
        var yearmonth = panel.items.getAt(4).getValue();
        var grid = panel.innerPanel;
        if(form.isValid()){
            form.submit({
                params: {
                    module: 'imsinspectionprogram'
                },

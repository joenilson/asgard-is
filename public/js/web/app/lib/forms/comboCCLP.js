 ...
 */
Ext.define('Asgard.lib.forms.comboCCLP', { 
    extend: 'Ext.form.Panel',
    alis: 'widnget.combocclp',
    border: false,
    plain: false,
    fieldDefaults: {
        labelAlign: 'top',
    ...
    initComponent: function(){
        ...
        this.submitButton = Ext.Object.merge({
                ...
                type: 'button',
                scope: me,
                handler: fnCCLPProcess
            }, this.submitButton);
        
        this.items = this.items || [];
        this.items = this.items.concat([ this.companiesField, this.countriesField, this.locationsField, this.processField ]);

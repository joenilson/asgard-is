...
Ext.define('Asgard.lib.Panels.SecurityHandbookPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.securityhandbookpanel',
    bodyPadding: 5,
    heigth: '100%',
    flex: 1,
    layout: 'fit',
    autoScroll: true,
    barAddText: 'Add Security Handbook',
    barRemoveText: 'Remove Security Handbook',
    ...
    initComponent: function(){
        ...
        this.tbar = [{ 
            ...
            handler: function() {
                ...
                var contentWin = Ext.create('Asgard.lib.forms.shNewSecurityHandbook', { innerPanel: dv });

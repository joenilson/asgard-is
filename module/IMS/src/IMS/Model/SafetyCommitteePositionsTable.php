...
use IMS\Model\Entity\SafetyCommitteePositions;

class SafetyCommitteePositionsTable extends AbstractTableGateway {

    protected $table_name = 'committee_positions';
    ...
    public function save(SafetyCommitteePositions $object)
    {
        $data = array(
            'lang' => $object->getLang(),
            'id' => $object->getId(),
        ...
        if (!$this->getPositionByLangId($lang,$id)) {
            ...
            throw new \Exception('lang or id in object Committee Positions does not exist');
        }
    }

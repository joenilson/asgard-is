...
class EmergencyPlan {
    ...
    public function getDate_emergencyplan() {
        return $this->date_emergencyplan;
    }

    public function setDate_emergencyplan($date_emergencyplan) {
        $this->date_emergencyplan = $date_emergencyplan;
        return $this;
    }

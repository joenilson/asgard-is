 ...
 */
class SafetyCommitteeProceedings {
    ...
    public function getDate_proceeding() {
        return $this->date_proceeding;
    }
    ...
    public function setDate_proceeding($date_proceeding) {

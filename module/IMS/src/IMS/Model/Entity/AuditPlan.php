...
class AuditPlan {
    ...
    public function getAudit_begin() {
        return $this->audit_begin;
    }

    public function getAudit_end() {
        return $this->audit_end;
    }
    ...
    public function setAudit_begin($audit_begin) {
        $this->audit_begin = $audit_begin;
        return $this;
    }

    public function setAudit_end($audit_end) {

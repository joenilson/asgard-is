...
class CSB {
    ...
    protected $cs_indicator_weight;
    protected $cs_indicator_order;
    ...
    public function getCs_indicator_weight() {
        return $this->cs_indicator_weight;
    }

    public function getCs_indicator_order() {
        return $this->cs_indicator_order;
    }
    ...
    public function setCs_indicator_weight($cs_indicator_weight) {
        $this->cs_indicator_weight = $cs_indicator_weight;
        return $this;
    }

    public function setCs_indicator_order($cs_indicator_order) {
        $this->cs_indicator_order = $cs_indicator_order;
        return $this;
    }

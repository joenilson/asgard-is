...
class MSDS {
    ...
    protected $filename;
    protected $is_toxic;
    protected $is_flammable;
    protected $is_reactive;
    protected $is_other;
    protected $status;
    ...
    public function getIs_toxic() {
        return $this->is_toxic;
    }

    public function getIs_flammable() {
        return $this->is_flammable;
    }

    public function getIs_reactive() {
        return $this->is_reactive;
    }

    public function getIs_other() {
    ...
    public function setIs_toxic($is_toxic) {
        $this->is_toxic = $is_toxic;
        return $this;
    }

    public function setIs_flammable($is_flammable) {
        $this->is_flammable = $is_flammable;
        return $this;
    }

    public function setIs_reactive($is_reactive) {
        $this->is_reactive = $is_reactive;
        return $this;
    }

    public function setIs_other($is_other) {

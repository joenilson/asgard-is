...
class ProcessOwnerProfile {
    protected $company;
    protected $country;
    protected $location;
    protected $lang;
    protected $id;
    protected $profile_desc;
    protected $profile_file;
    protected $status;
    ...
    public function getProfile_desc() {
        return $this->profile_desc;
    }

    public function getProfile_file() {
    ...
    public function setProfile_desc($profile_desc) {
        $this->profile_desc = $profile_desc;
        return $this;
    }

    public function setProfile_file($profile_file) {

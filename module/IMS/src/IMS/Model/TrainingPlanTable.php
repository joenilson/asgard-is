...
class TrainingPlanTable extends AbstractTableGateway {

    protected $table_name = 'trainingplan';
    ...
    public function getTrainingPlanByCCL($company,$country,$location)
    {
    ...
    public function getTrainingPlanByCCLId($company,$country,$location,$id)
    {
    ...
    public function save(TrainingPlan $object)
    {
        $data = array(
        ...
        if (!$this->getTrainingPlanByCCLId($company,$country,$location,$id)) {
            ...
            return $data['id'];
        } elseif ($this->getTrainingPlanByCCLId($company,$country,$location,$id)) {
    ...
    public function updateTrainingPlan($company,$country,$location,$id,$data)
    {
